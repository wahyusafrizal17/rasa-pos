...
@section('content')
    @unless ($exporting ?? false)
        <div class="mb-6 flex flex-wrap items-end justify-between gap-4">
            <p class="text-sm text-slate-500">Hasil produksi dan yield</p>
        ...
        <form method="GET" action="{{ route('reports.production') }}" class="card mb-6 p-5">
            <div class="grid gap-3 md:grid-cols-2 xl:grid-cols-5">
                ...
                <div>
                    ...
                    <input class="input" type="search" name="search" value="{{ $filters['search'] ?? '' }}" placeholder="Nomor / produk">
                </div>
        ...
        <div class="table-wrap">
            <table class="data-table">
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="py-16 text-center text-sm text-slate-400">Tidak ada data produksi pada periode ini.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
