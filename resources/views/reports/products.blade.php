...
@section('content')
    @unless ($exporting ?? false)
        <div class="mb-6 flex flex-wrap items-end justify-between gap-4">
            <p class="text-sm text-slate-500">Penjualan per produk</p>
        ...
        <form method="GET" action="{{ route('reports.products') }}" class="card mb-6 p-5">
        ...
        <div class="table-wrap">
            <table class="data-table">
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="3" class="py-16 text-center text-sm text-slate-400">Tidak ada penjualan produk pada periode ini.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
